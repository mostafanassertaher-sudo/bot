...
# الاسم الجديد اللي إنت اخترته للملف بالظبط
...
def send_welcome(message):
    bot.reply_to(message, "أهلاً يا درش! ابعت اللينك واختار الجودة وهنزلك الفيديو فوراً بملف الكوكيز الجديد 🎬")
...
def callback_query(call):
    ...
    # إعدادات التحميل مع ميزة المشاهدة الفورية والاسم الجديد للكوكيز
    ydl_opts = {
        ...
        # ميزة المشاهدة الفورية (FastStart)
        'postprocessor_args': ['-movflags', '+faststart'],
        
        'max_filesize': 48000000, # حد تليجرام 50 ميجا
        'noplaylist': True,
        'quiet': True
    }
    ...
    try:
        ...
        # إرسال الفيديو مع تفعيل خاصية الـ Streaming
        with open(filename, 'rb') as f:
            bot.send_video(chat_id, f, supports_streaming=True)
        
        # مسح الملف لتوفير المساحة
